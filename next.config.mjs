        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.s3.amazonaws.com https://*.s3.ap-south-1.amazonaws.com https://*.cloudfront.net https://*.clarity.ms https://www.google-analytics.com https://www.googletagmanager.com https://github-contributions-api.jogruber.de https://vercel.live wss://ws-us3.pusher.com https://*.ingest.sentry.io https://cloudflareinsights.com https://static.cloudflareinsights.com",
...
const withMDX = createMDX({
  options: {
    ...
    rehypePlugins: [
      ...
      ['rehype-prism-plus', { ignoreMissing: true }], // Syntax highlighting; Mermaid fences are rendered on the client
    ],
  },
});
