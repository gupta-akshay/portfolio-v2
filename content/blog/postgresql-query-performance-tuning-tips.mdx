export const metadata = {
    ...
    coverImage: '/images/blog/postgresql-query-performance-tuning-tips.webp',
    coverImageAlt: 'PostgreSQL Query Performance Tuning Tips',
    author: {
        name: 'Akshay Gupta',
        avatar: '/images/blog-author.webp'
    },
    excerpt: 'Practical PostgreSQL optimization techniques: indexing strategies, query rewrites, and configuration tweaks to drastically improve database performance.'
}
