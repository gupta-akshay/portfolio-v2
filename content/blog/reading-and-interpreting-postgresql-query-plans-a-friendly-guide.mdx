export const metadata = {
    ...
    coverImage: '/images/blog/reading-and-interpreting-postgresql-query-plans-a-friendly-guide.webp',
    coverImageAlt: 'Reading and Interpreting PostgreSQL Query Plans',
    author: {
        name: 'Akshay Gupta',
        avatar: '/images/blog-author.webp'
    },
    excerpt: 'Demystifying PostgreSQL EXPLAIN and EXPLAIN ANALYZE. Learn to read query plans, understand scan types, joins, and diagnose performance bottlenecks.'
}
