export const metadata = {
    ...
    coverImage: '/images/blog/terminal-resume-ssh-ssh-akshaygupta-live.webp',
    coverImageAlt: 'Terminal Resume - ssh.akshaygupta.live',
    author: {
        name: 'Akshay Gupta',
        avatar: '/images/blog-author.webp'
    },
    excerpt: '[Deprecated] An SSH-accessible resume that greeted visitors with neon figlet banners and interactive commands. Built with TypeScript, ssh2, and deployed on Fly.io. The hosted SSH endpoint and the in-app CTA were retired in May 2026.'
}
