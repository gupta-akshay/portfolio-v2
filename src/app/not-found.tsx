...
import { MagneticHover, RippleEffect, ScrollAnimation, TextAnimation } from '@/app/components';
      ...
      <div className={styles.notFound}>
        <div className='container'>
          <div className={`${styles.notFoundContent} col-12 d-flex flex-column justify-content-center align-items-center`}>
            ...
            <ScrollAnimation animation='fadeIn' duration={0.8} delay={0.4} scrollReveal={true}>
