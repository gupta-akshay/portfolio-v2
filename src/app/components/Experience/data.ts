const data = [
  ...
  },
  {
    ...
    responsibilities: `
      <ul>
        <li>Built an integrated application combining Tableau, PowerBI, and SAP BO with SSO via Azure and conducted extensive React.js training, elevating organizational development capabilities.</li>
      </ul>
    `,
  ...
  },
  {
    ...
    responsibilities: `
      <ul>
        <li>Completed intensive Java and Spring Boot training and developed a dashboard application with SAP OData, providing actionable sales insights.</li>
      </ul>
    `,
    imgSrc: '/images/tcs.svg',
  },
