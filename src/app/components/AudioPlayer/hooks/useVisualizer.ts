...
export const useVisualizer = (
  ...
  const drawMiniVisualizer = useCallback(() => {
    ...
    // Only resize canvas if dimensions have changed
    if (miniCanvas.width !== miniCanvas.offsetWidth || miniCanvas.height !== miniCanvas.offsetHeight) {
    ...
    try {
      ...
      const scaleFactor = prevScaleFactor * smoothingFactor + newScaleFactor * (1 - smoothingFactor);
